...
func getCeleryMessage(encodedTaskMessage string) *CeleryMessageV1 {
	msg := celeryMessagePool.Get().(*CeleryMessageV1)
	msg.Body = encodedTaskMessage
	return msg
}

func releaseCeleryMessage(v *CeleryMessageV1) {
	v.reset()
...
func (cm *CeleryMessageV1) GetTaskMessage() *TaskMessage {
